...
> **Canonical copy for in-app Documentation:** [`docs/user-manuals/med-compliance.md`](user-manuals/med-compliance.md) (registry slug `med-compliance`). Edit that file first, then mirror changes here.
