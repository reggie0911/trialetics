            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    `border-input hover:bg-secondary/80 dark:hover:bg-accent/80 flex h-16 w-16 cursor-pointer items-center justify-center rounded-sm border transition-all duration-300`,
                    isActive && 'bg-secondary dark:bg-accent',
                  )}
                >
          ...
          >
            <CarouselContent className="h-full">
              {features.map((feature) => (
                ...
                >
                  <Card className="bg-secondary dark:bg-card border-input aspect-[284/362] h-full !pb-0 transition-all duration-300 hover:shadow-lg lg:aspect-[384/562]">
                    <CardHeader>
                    ...
                    <CardContent className="relative h-full">
                      <div className="bg-card dark:bg-accent border-input relative h-full overflow-hidden rounded-lg border">
                        <Image
                      ...
                      <div className="absolute inset-0 bg-gradient-to-b from-transparent from-70% to-white dark:to-card"></div>
                    </CardContent>
                  </Card>
                </CarouselItem>
              ))}
