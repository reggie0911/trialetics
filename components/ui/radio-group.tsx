  ...
  return (
    ...
    >
      <RadioPrimitive.Indicator
        ...
        className="group-aria-invalid/radio-group-item:text-destructive text-primary group-data-[checked]/radio-group-item:text-white flex size-4 items-center justify-center"
      >
