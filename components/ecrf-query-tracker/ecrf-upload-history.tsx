...
interface ECRFUploadHistoryProps {
  uploads: Tables<'ecrf_uploads'>[];
  selectedUploadId: string | null;
  onUploadSelect: (uploadId: string) => void;
  onUploadDelete?: (uploadId: string) => void;
}

export function ECRFUploadHistory({
  uploads,
  selectedUploadId,
  onUploadSelect,
  onUploadDelete,
}: ECRFUploadHistoryProps) {
    ...
    <>
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent className="w-full sm:max-w-md">
          <SheetHeader>
            <SheetTitle>eCRF Query Upload History</SheetTitle>
            <SheetDescription className="text-xs">
              View and manage previous eCRF query data uploads
            </SheetDescription>
          </SheetHeader>
              ...
              {uploads.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    No uploads yet. Upload your first eCRF query data CSV file to get started.
                  </p>
                </div>
              ) : (
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-xs">
              This will permanently delete this upload and all associated query records.
