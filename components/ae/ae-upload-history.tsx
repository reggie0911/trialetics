...
interface AEUploadHistoryProps {
  uploads: Tables<'ae_uploads'>[];
  selectedUploadId: string | null;
  onUploadSelect: (uploadId: string) => void;
  onUploadDelete?: (uploadId: string) => void;
}

export function AEUploadHistory({
  uploads,
  selectedUploadId,
  onUploadSelect,
  onUploadDelete,
}: AEUploadHistoryProps) {
        ...
        <SheetContent className="w-full sm:max-w-md">
          <SheetHeader>
            ...
            <SheetDescription className="text-xs">
              View and manage previous adverse event data uploads
            </SheetDescription>
          </SheetHeader>
              ...
              {uploads.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    No uploads yet. Upload your first AE data CSV file to get started.
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 text-[11px] text-muted-foreground mt-1.5">
                          <div className="flex items-center gap-1">
                            ...
                            <span>{upload.row_count} AE records</span>
                          </div>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this upload and all associated AE records.
