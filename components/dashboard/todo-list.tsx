    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between mb-2">
        <Button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white font-medium text-[10px] px-2 py-1 h-6"
        >
          + New Task
        </Button>
        ...
        <div className="flex items-center gap-1">
          <select
            ...
            className="text-[10px] border border-slate-300 rounded-md px-2 py-1 bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          >
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-2 border border-blue-200">
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <h2 className="text-[10px] font-semibold text-slate-900">Ongoing Tasks</h2>
          {ongoingTodos.length > 0 && (
            <span className="ml-auto bg-blue-600 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full">
              {ongoingTodos.length}
            </span>
          )}
        </div>
        {ongoingTodos.length === 0 ? (
          <div className="text-center py-4 bg-white rounded-lg border border-dashed border-slate-300">
            <p className="text-[10px] text-slate-500">No ongoing tasks</p>
          </div>
        ) : (
          <>
            ...
            {ongoingTodos.length > 5 && !showAllOngoing && (
              <Button
                ...
                className="mt-1 text-[10px] text-blue-600 hover:text-blue-700 h-auto p-0"
              >
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-2 border border-green-200">
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <h2 className="text-[10px] font-semibold text-slate-900">Completed Tasks</h2>
          {completedTodos.length > 0 && (
            <span className="ml-auto bg-green-600 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full">
        ...
        {completedTodos.length === 0 ? (
          <div className="text-center py-4 bg-white rounded-lg border border-dashed border-slate-300">
            <p className="text-[10px] text-slate-500">No completed tasks</p>
          </div>
        ) : (
          <>
            <div className="space-y-1">
            ...
            {completedTodos.length > 5 && !showAllCompleted && (
              <Button
                ...
                className="mt-1 text-[10px] text-green-600 hover:text-green-700 h-auto p-0"
              >
