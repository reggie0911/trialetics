...
const myTasks: OnboardingStepDef = {
  ...
  title: 'My tasks',
  body:
    'Work assigned to you appears here. Check due dates and status as your studies progress.',
  kind: 'coach',
  routePrefix: '/protected/my-tasks',
...
const visits: OnboardingStepDef = {
  ...
  body:
    'Review scheduled and completed site visits across studies you can access.',
  kind: 'coach',
  routePrefix: '/protected/visits',
  anchor: 'page-visits',
...
const tripReportsUser: OnboardingStepDef = {
  ...
  title: 'Trip reports',
  body:
    'Open this area to work on visit reports and see items waiting in the queue, depending on your role.',
  kind: 'coach',
