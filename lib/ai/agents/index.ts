...
const moduleContextMap: Record<string, string[]> = {
  ...
  'contacts-organizations': ['/protected/directory', '/protected/contacts-organizations'],
  ...
  'study-manager': ['/protected/clinical-trials', '/protected/studies'],
  'startup-activation': ['/protected/site-startup'],
  'milestones-timeline': ['/protected/studies'],
  ...
  'contracts-budget': ['/protected/financials/approvals', '/protected/clinical-payments'],
