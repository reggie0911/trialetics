-- Create RPC function to get subject-level aggregates for a site
-- This returns aggregated data by subject instead of all field-level records
...
COMMENT ON FUNCTION get_sdv_subject_summary IS 'Get subject-level summary for a site (aggregated from field-level data)';
