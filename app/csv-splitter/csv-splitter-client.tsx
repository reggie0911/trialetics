...
export default function CsvSplitterClient() {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="space-y-8">
        ...
        <CsvSplitterForm onSplitComplete={handleSplitComplete} onError={handleError} />
        ...
        <ChunkViewer filename={selectedChunk} open={isViewerOpen} onClose={handleCloseViewer} />
      </div>
    </div>
  );
}
