...
import { IrbTrackingClient } from '@/components/irb-tracking/irb-tracking-client';

export default async function IrbTrackingPage() {
    ...
    <div className="min-h-screen bg-[#E9E9E9]">
      ...
      <main className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 py-4 sm:py-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold">IRB/EC Tracking</h1>
        ...
        <IrbTrackingClient companyId={profile.company_id} />
      </main>
    </div>
  );
}
