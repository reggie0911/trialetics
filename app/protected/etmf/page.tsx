...
import { EtmfClient } from '@/components/etmf/etmf-client';
    ...
    <div className="min-h-screen bg-[#E9E9E9]">
      ...
      <main className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 py-4 sm:py-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold">eTMF</h1>
            <p className="text-sm text-muted-foreground">
              Electronic Trial Master File with DIA reference model structure
            </p>
          </div>
          <ModuleNavbar />
        </div>
        <EtmfClient companyId={profile.company_id} />
      </main>
    </div>
  );
}
