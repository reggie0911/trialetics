...
import { FinancialForecastingClient } from '@/components/financial-forecasting/financial-forecasting-client';
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Budget line items, spend actuals, forecasts, and variance reports
            </p>
          </div>
          <ModuleNavbar />
        </div>
        <FinancialForecastingClient companyId={profile.company_id} />
      </main>
    </div>
  );
}
