...
import { VendorManagementClient } from '@/components/vendor-management/vendor-management-client';
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Track vendor profiles, contracts, deliverables, and performance KPIs
            </p>
          </div>
          <ModuleNavbar />
        </div>
        <VendorManagementClient companyId={profile.company_id} />
      </main>
    </div>
  );
}
