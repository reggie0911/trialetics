...
export default async function StudySiteEditPage({ params }: PageProps) {
    ...
    <div className="p-6 space-y-6 max-w-4xl">
      <div className="space-y-1">
        <Button
          variant="ghost"
          size="sm"
          render={<Link href={`/protected/studies/${studyId}/sites/${siteId}`} />}
          nativeButton={false}
          className="-ml-2"
        >
        ...
        <p className="text-muted-foreground">Update details for {site.name}.</p>
      </div>
