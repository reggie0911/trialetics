-- =====================================================
-- Task Management: study_milestones, tasks, task_comments
-- Recreates tables after 20260316400000 drop with updated schema.
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.tasks (
  ...
  on_track_status TEXT CHECK (on_track_status IN ('on_track', 'at_risk', 'off_track')),
  planned_start_date DATE,
  due_date DATE,
  completed_date DATE,
